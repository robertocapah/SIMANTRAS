...
import shp.template.Data.CustomVolleyResponseListener;
...
import shp.template.Repo.mCounterDataRepo;
...
//        RequestQueue queue = Volley.newRequestQueue(ctx.getApplicationContext());
    ...
    public void volleyRequestSendData(final Context ctx,String strLinkAPI, final clsPushData mRequestBody, final VolleyResponseListener listener) {
        ...
        shp.template.Data.VolleyMultipartRequest multipartRequest = new shp.template.Data.VolleyMultipartRequest(Request.Method.POST, strLinkAPI, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Boolean status = false;
                String errorMessage = null;
