...
import shp.template.Repo.RepomMenu;
import shp.template.Repo.RepomUserRole;
...
import shp.template.Utils.ClsTools;
...
public class ActivityPickAccount extends Activity {
    ...
    public void getRole(final String[] data_token, final Activity activity, final AccountManager mAccountManager){
        ...
        new BLHelper().volleyLogin(activity, strLinkAPI, mRequestBody, "Getting your role......",false, new InterfaceVolleyResponseListener() {
            @Override
