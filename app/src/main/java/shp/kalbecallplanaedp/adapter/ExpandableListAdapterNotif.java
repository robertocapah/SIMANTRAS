...
public class ExpandableListAdapterNotif extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapterNotif(Context mContex, List<clsItemGroupNotifAdapter> _listDataHeader, HashMap<clsItemGroupNotifAdapter, List<clsListItemAdapter>> _listDataChild){
