...
public class AdapterListBasicIssue extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterListBasicIssue(Context context, List<VmAdapterBasic> items) {
        this.items = items;
        ctx = context;
    }
